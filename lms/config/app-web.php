	...
	'components' => [
		...
		*/
        ...
        'fileStorage' => [
            ...
            'baseUrl' => '@web/source',
            'filesystem' => [
                'class' => app\components\filesystem\LocalFlysystemBuilder::class,
                'path' => '@app/../public/source'
            ],
            'as log' => [
                'class' => app\behaviors\FileStorageLogBehavior::class,
